...
Формат строго такой (вот пример структуры):

Название: Vatican Gardens
Описание: Уединённый парк с атмосферой спокойствия, живописными аллеями и прудом.
Адрес (на английском языке): Viale Vaticano, Vatican City, Italy

Название: St. Peter’s Dome
Описание: Панорамный вид на город с купола собора. Лучшая точка для рассвета.
Адрес (на английском языке): Piazza San Pietro, Vatican City, Italy

Название: Borgo Pio
Описание: Улица с кафе и атмосферой старого Рима. Отличное место для обеда.
Адрес (на английском языке): Borgo Pio, Rome, Italy

❌ Не добавляй дефисы, цифры или лишний текст. Только 3 карточки — в этом формате.
`);
